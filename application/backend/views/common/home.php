                                    ...
                                    <tbody>
                                        <?php foreach ($result as $row) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo site_url('home/profile/'. $row['user_id']);?>"><?php echo $row['firstname'];?></a></td><!--here showing all data of the mobile's field-->
                                                ...
                                                <td>
                                                    ...
                                                    <a class =" btn-success" href="<?php echo site_url('home/edit') . '/' . $row['address_id']; ?>">  <button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span></button></a><!-- link is used to go to update page-->
                                                    <a  class =" btn-success" href="<?php echo site_url('home/getList') .'/'. $row['address_id'];?>">  <button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span></button></a><!-- link is used to go to view page-->
