...
//        print_r($data);die;
        ...
        $this->layout->view('common/home', $data);
    }
    ...
    public function getList($address_id) {
        ...
        $this->layout->view('common/addressview', $data);
    }
    ...
    protected function addForm() {
        ...
        $this->layout->view('common/insert');
    }
    ...
    protected function getEditForm($address_id) {
        ...
        $this->layout->view('common/edit_address', $data);
    }
    ...
    public function geteditProfileForm($user_id = '') {
        ...
        $data['images'] = $this->file_manager->fetch_image($user_id);
...
//
    public function profile($user_id = 0) {
        $data = $this->addressmodel->profile($user_id);
...
//    }
    ...
    public function users() {
        $data['result'] = $this->addressmodel->get_users();
      
        
        $this->layout->set_title('users');
        $data['delete'] = site_url('home/delete_user');
    ...
    public function delete_user() {
        ...
        if ($this->input->post('selected')) {
            ...
            foreach ($this->input->post('selected') as $user_id) {
                ...
                $this->addressmodel->drop($user_id);
            }
            $this->session->set_flashdata('message', 'You have modified Users!');
            redirect('home/users');
        }
