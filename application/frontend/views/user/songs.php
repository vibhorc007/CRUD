                                ...
                                if (isset($songs) && !empty($songs)) {
                                    ...
                                    foreach ($songs as $song) {
                                        ...
                                        <tr>
                                            ...
                                            <td><audio controls>
                                                    <source src="songs/<?php echo $song['file_name']; ?>" type="<?php echo $song['file_ext']; ?>" value="">

                                                </audio></td>
                                            <td>

                                                <button type="button" onclick="myfunction(<?php echo $song['image_id']; ?>)" data-toggle="modal" data-target="#myModal4" class="btn btn-danger  hvr-grow-shadow"><span class="glyphicon glyphicon-trash "></span></button> 
                                            </td>
