                        ...
                        <li>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"> <?php echo $this->session->username . "&nbsp" . $this->session->lastname; ?> </span>
                                </a>
                                <ul class="dropdown-menu animated zoomInDown">
                                    <!-- User image -->
                                    <li class="user-header ">
                                        <img src="<?php echo $this->u->getUserImage(); ?>" class="user-image" alt="User Image">
<!--                                        <img src="<?php echo base_url('images') . '/' . $this->session->image; ?>" class="img-circle" alt="User Image">-->

                                        <p>
                                            <?php echo $this->session->username . "&nbsp" . $this->session->lastname; ?>  - Web Developer
...
<!--                                     Menu Body 
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo base_url('home/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
                                        </div>
